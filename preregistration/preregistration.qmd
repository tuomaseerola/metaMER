...
metamer_prereg <-
  ...
  preregr::prereg_specify(
    title = "Music emotion recognition: Meta-analysis of regression and classification success of valence and arousal ratings from audio",
...
metamer_prereg <-
  ...
  preregr::prereg_specify(
    ...
    screening_reconciliation_procedure = "We reconciled discrepancies through discussion, resolving “unsure” votes first, followed by discrepancies in include/exclude decisions between authors Results of this updating procedure are available in the <A HREF=https://tuomaseerola.github.io/metaMER/studies/pass3_comparison.html>Pass 3 comparison document</A>.",
...
metamer_prereg <-
  ...
  preregr::prereg_specify(
    ...
    extractor_instructions = "See Extraction details.",
    ...
    extraction_reconciliation_procedure = "NA",
    extraction_procedure_justification = "TO BE DETAILED",
    extraction_data_management_and_sharing = "We retain the information of the studies in shared bibtex files, extraction data will be stored in ascii data files (.R), and the analysis and manuscript will be available in quarto/markdown files, and all these are managed, structured, shared and documented in Github repository according to FAIR principles.",
...
quality_assessment = "Not all the bias assessment tools for clinical studies are relevant for our purposes, we adapt the overall approached advocated in https://doi.org/10.1136/bmj.d5928 especially concerning #4. making our own risk of bias judgements transparent.",
synthesis_plan = "We analyse regression and classification studies separately, and depending on the quantity of the studies forming suitable sub-groupings, we may further synthesise the results across groupings that are formed along feature sets or music genres",
...
synthesis_procedure_justification = "TO BE DETAILED",
