...
The number of features (as classified into under 30, between 30 and 300, and above 300 features) analyzed does not significantly impact results (_Q_(2) = 3.91, _p_ = 0.1419), despite $MCC$s showing average differences according to the number of features (< 30 F: $MCC$ = 0.9293; 30-300 F: $MCC$ = 0.8458; >300 F: $MCC$ = 0.7754). Similarly, the class of model did not differ significantly (_Q_(3) = 4.22, _p_ = 0.239) despite neural networks attaining highest average performance ($MCC$ = 0.9307), followed by SVMs ($MCC$ = 0.870) and tree-based methods ($MCC$ = 0.854), then linear methods ($MCC$ = 0.728). Finally, neither single- vs. multigenre studies (_Q_(1) = 0.12, _p_ = 0.7324), nor binary vs. multi-class models (_Q_(1) = 0.03, _p_ = 0.8694) differed significantly. 

<!-- TODO @Cameron: could you also check whether the journal type made a difference to classification results? We report these in the regression section (a had talked about this in the pre-registration so it might be worth 1 sentence). -->
