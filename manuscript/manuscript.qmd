...
digraph sub {
  ...
  H [label = "Full text articles excluded
             (n = 50)"]
  I [label = "Studies excluded in final review (n = 8)"]
  J [label = "Final selection (n = 38)"]
  A->B
  A->C
  C->D
  D->E [ minlen = 3 ]
...
-   [OTHER GROUPINGS? STIMULUS MIXED/SINGLE GENRE, PREDICTION/EXPLANATION](to%20explore?)
