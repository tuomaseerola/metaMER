...
Figure 4 shows forest and funnel plot visualizations from the random-effects model of the best-performing models in classification studies. _MCC_s vary across a wide range, reporting _MCC_s between 0.55 to 0.98. Table 4 indicates that using the best model from each study increases performance relative to all models ($MCC$ = 0.8684 95%CI: 0.7475-0.9336), yet slightly increases heterogeneity ($\tau^2$ = 0.3180, $I^2$ = 99.8%).  
