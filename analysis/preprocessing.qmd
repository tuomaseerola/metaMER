...
R_studies$feature_n[str_detect(R_studies$feature_n,'150 PCA features')]<-3000 #discuss
R_studies$feature_n[str_detect(R_studies$feature_n,' 50 PCA features')]<-  499 #resolved
R_studies$feature_n[str_detect(R_studies$feature_n,'60 handcrafted and')]<-60 # this should be 14400+60! discuss
...
R_studies$feature_n[str_detect(R_studies$feature_n,'6670 in MediaEval')]<-6670 #discuss
R_studies$feature_n[str_detect(R_studies$feature_n,'557 before feature')]<-557 #resolved
# this seems to refer to yang2021an, which is handled above with "6670 in mediaeval"
# R_studies$feature_n[str_detect(R_studies$feature_n,'not specified')]<-NA
# 2025-01-15
# beveridge2018po. This one is worth discussing as the two studies might be worth differentiating. 
# Using higher value for now. DISCUSS
R_studies$feature_n[str_detect(R_studies$feature_n,'study 1: 26, study 2: 28')] <- 28
