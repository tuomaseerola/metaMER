...
To assess how the use of different model types affected performance, we prepared heatmap visualizations depicting differences in success across feature *n* categories. We collapsed SVM and Tree-Based categories due to their low representation in the model summary. Figure 5 reveals studies using smaller feature sets tend to perform best, whereas the best model class differs depending on the prediction task.

![Heatmap Depicting Success Across Tasks](../manuscript/heat_map_figure.png "Heatmap depicting success across tasks according to Feature N category and model class. Labels indicate the number of studies and the median number of stimuli is shown in parentheses."){width="892"}
...
[^3]: @chen2017co was the only study in the included studies using Gaussian Mixture Models. We decided to group this with SVMs, as they are commonly applied in similar contexts and have been used together in hybrid systems.
