...
```{=html}
<!--
- Wide range of MER models attempting to outperform previous benchmarks, comparing performance against baseline models
- Introduce ceilings for classification, valence, and arousal, citing Barthet study
- Citing what some researchers attribute limitations to (e.g., lower valence than arousal)
- MIR discussions of "semantic" challenge
