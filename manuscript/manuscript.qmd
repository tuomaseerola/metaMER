...
These comparisons of sub-groupings are also influenced by other factors, such as the type of stimuli used in the studies and whether the objective is to explain or predict emotions. Although the sub-groupings result in an uneven distribution of studies and observations, they still offer valuable insights. Despite these caveats, the current sub-groupings enable us to identify interesting differences related to model success across the studies.
